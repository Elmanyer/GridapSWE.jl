...
# command to execute:
# mpiexecjl -n 4 julia --project=. run/run_SWE_DG_distributed_benchmark.jl
...
GridapSWE.run_distributed_benchmark(:sinusoidal, :DG, dom_params, solver_params, (2,2), output=true)